...
class TaskIntegrationTest(TestCase):
    ...
    def test_task_create_invalid_data(self):
        ...
        long_description = """Lorem Ipsum es simplemente el texto de
        ...
        1500, cuando un impresor (N. del T. persona que se dedica a
...
class TaskIntegrationExtremeCasesTest(TestCase):
    def setUp(self):
        ...
        self.non_owner = User.objects.create_user(
            username="non_owner", password="12345"
        )
        self.task = Task.objects.create(
            user=self.owner,
            title="Test Task",
